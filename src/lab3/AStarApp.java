 ...
 * найден, оно отображается зеленым цветом.
 **/
public class AStarApp {
    ...
    /**
     * Это двухмерный массив компонентов пользовательского интерфейса, которые
     * обеспечивают отображение и управление ячейками на карте.
     ***/
     ...
     * создается новый объект {@link Map2D}, который инициализируется из
     * текущего состояния приложения. Затем вызывается средство поиска пути A*,
